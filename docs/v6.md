...
> **This is the v6.0 reference, kept as historical record.** Current specification: **[SSL v7.0](../v7/)** — adds three deterministic-safety primitives (`@scope`, `@adversarial_battery`, `@audit_chain`) on top of v6. Every v6 feature remains unchanged in v7; v7 is additive. New work should target v7.
...
**Successor:** [SSL v7.0 specification](../v7/)
